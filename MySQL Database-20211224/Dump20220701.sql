...
CREATE TABLE `licenses` (
  ...
  `devices` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `system_devices` (
  ...
  `mac` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `local_ip` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `local_web_port` int DEFAULT NULL,
  `port` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `remote_ip` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `link_password` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `system_servers` (
  ...
  `nic0_mac` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `nic0_ip` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `nic0_subnet` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `nic0_gateway` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `nic0_port` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `nic1_mac` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `nic1_ip` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `nic1_subnet` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `nic1_gateway` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `nic1_port` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `nic2_mac` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `nic2_ip` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `nic2_subnet` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `nic2_gateway` varchar(20) COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `system_servers` VALUES (1,17,'CCTV',1,'0','dfgdfgdfnhkh fdghdfgdfg',671,'HIHUI','N/A','','','','','','','10.10.10.10','','','','','','','','','','','','','','','','',''),(2,17,'CCTV',1,NULL,'dfgdfgdf',671,'','N/A','','','','','','','','','','','','','','','','','','','','','','','',''),(3,17,'CCTV',1,NULL,'dfgdfgdf',671,'','N/A','','','','','','','','','','','','','','','','','','','','','','','',''),(4,17,'CCTV',1,NULL,'dfgdfgdf',671,'','N/A','','','','','','','','','','','','','','','','','','','','','','','','');
...
INSERT INTO `wh_supplierreturn` VALUES (3,29,0,667,1,16,'N/A','2022-06-25 13:59:44','ykotov','2022-07-01 21:03:55','ykotov',''),(4,0,0,NULL,1,16,'N/A','2022-06-25 15:18:31','ykotov','2022-06-25 15:18:31','ykotov',''),(5,29,0,NULL,1,16,'N/A','2022-06-25 16:06:24','ykotov','2022-06-25 16:06:24','ykotov',''),(6,29,0,NULL,1,17,'N/A','2022-06-26 16:41:31','ykotov','2022-06-26 16:41:31','ykotov',''),(7,29,0,667,1,16,'N/A','2022-07-01 21:05:05','ykotov','2022-07-01 21:05:05','ykotov','');
...
-- Dump completed on 2022-07-01 22:23:57
